...
class PagSeguroConfigWrapper
{
     ...
     *
     */
    const PAGSEGURO_EMAIL = "$adm->administrador_email";
    /**
     *
     */
    const PAGSEGURO_TOKEN_PRODUCTION = "$adm->administrador_token_pagseguro";
    /**
     *
     */
     ...
     */
    const PAGSEGURO_LOG_LOCATION = "../PagSeguroLibrary/logs.txt";
